...
window.globals = {
    ...
    mqttParamZ: getUrlParam('mqttServer', 'localhost'), // PATCH!! TODO: move default/config values to a seperate file so we can replace them without replacing the entire code file
